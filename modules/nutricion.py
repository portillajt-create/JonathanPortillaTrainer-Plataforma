...
def generar_notas_adicionales(peso_kg: float, edad: int, nivel_actividad: str, ajuste_pct: int) -> str:
    ...
    return (
        ...
        "- Cuando el plan indica que un alimento es 'crudo' o 'cocido', se refiere a en qué momento "
        "pesarlo (antes o después de cocinarlo), no a cómo debes comerlo — por ejemplo, 'avena cruda' "
        "se pesa antes de cocinarla, aunque la comas caliente; 'arroz cocido' se pesa ya cocido.\n"
